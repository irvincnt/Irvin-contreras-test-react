...
function AuthGuard({ children }: AuthGuardProps): React.ReactElement {
      ...
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-red-500 to-pink-500">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            Este módulo solo puede ser accedido a través de la aplicación principal.
          </p>
          <a
            href="http://localhost:3000"
            className="inline-block bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200 font-semibold"
          >
